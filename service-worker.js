const CACHE='albion-market-pages-v5.5.2-ios-db-fallback';
const CORE=['./','./index.html','./app.js?v=5.5.1','./refining.html','./refining-engine.js','./refining.js','./offline.html','./manifest.webmanifest','./icon.svg'];
