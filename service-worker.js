const CACHE='albion-market-pages-v5.5.5-refining-audit-fixes';
const CORE=['./','./index.html','./app.js','./refining.html','./refining-engine.js','./refining.js','./offline.html','./manifest.webmanifest','./icon.svg'];
